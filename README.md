...
#### Junior Developer
 ...
 <B>Junior Developer | Solving Problems with Error-Free Websites </B>
Junior developer with a solid foundation in backend development using C#, .NET Core, and ASP.NET Core MVC. Proficient in frontend technologies like Angular, React.js, HTML5, and CSS3. Experienced in building secure APIs, developing user-friendly interfaces, and managing databases with SQL Server and Entity Framework. During my internship, I contributed to cross-platform projects and collaborated across the tech stack, delivering high-quality solutions. Eager to apply my skills to support dynamic and innovative projects that not only enhance user experience but also contribute to the overall success of the team and organization.

Skills: ASP.NET CORE API|ASP.NET CORE MVC|SQL|C# | ANGULAR |REACT JS | JS | HTML | CSS |ADO.NET |NODEJS |BOOTSTRAP| MAUI
...
<p align="center">
  ...
  <a href="mailto:shahinurr670@gmail.com" target="_blank">
